    ...
    <div className="flex justify-center flex-col h-full w-full space-y-4 p-8">
      ...
      <ul className="list-disc list-inside">
        ...
        <li>
          ...
          the development server from <code>Vite</code> runs in the background
          automatically, so your client-side resources are dynamically built on
      ...
      <p>
        ...
        based on the <code>Vite+Inertia+Typescript</code> template. If you open
        a command prompt in that directory, you can run <code>npm</code>{" "}
